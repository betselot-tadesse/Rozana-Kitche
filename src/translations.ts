...
export const translations = {
  en: {
    ...
    admin: {
      ...
      weekdays: 'Weekdays Hours',
      weekends: 'Weekends Hours',
  ...
  ar: {
    ...
    admin: {
      ...
      email: 'البريد الإلكتروني',
      location: 'العنوان',
      weekdays: 'ساعات أيام الأسبوع',
      weekends: 'ساعات عطلة نهاية الأسبوع',
  ...
  hi: {
    ...
    admin: {
      ...
      weekdays: 'कार्यदिवस का समय',
      weekends: 'सप्ताहांत का समय',
  ...
  ur: {
    ...
    contact: {
      ...
      placeholders: {
        name: 'جان ڈو',
        email: 'john@example.com',
        subject: 'ہم آپ کی کیسے مدد کر سکتے ہیں؟',
        message: 'آپ کا پیغام یہاں...'
      }
    },
    testimonials: {
      label: 'تاثرات',
    ...
    admin: {
      ...
      phone: 'فون نمبر',
      email: 'ای میل پتہ',
      location: 'مقام کا پتہ',
      weekdays: 'ہفتے کے دنوں کے اوقات',
      weekends: 'ہفتہ وار تعطیلات کے اوقات',
      saveContact: 'رابطے کی معلومات محفوظ کریں',
